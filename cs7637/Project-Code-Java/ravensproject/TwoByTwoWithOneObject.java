...
public class TwoByTwoWithOneObject {
    ...
    private List<RavensObject> objectsA = new ArrayList<RavensObject>();

    private List<RavensObject> objectsB = new ArrayList<RavensObject>();

    private List<RavensObject> objectsC = new ArrayList<RavensObject>();

    private List<RavensObject> objects1 = new ArrayList<RavensObject>();

    private List<RavensObject> objects2 = new ArrayList<RavensObject>();

    private List<RavensObject> objects3 = new ArrayList<RavensObject>();

    private List<RavensObject> objects4 = new ArrayList<RavensObject>();

    private List<RavensObject> objects5 = new ArrayList<RavensObject>();

    private List<RavensObject> objects6 = new ArrayList<RavensObject>();
    ...
    public TwoByTwoWithOneObject(RavensProblem problem) {
